    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p>Sur nos différents objets, nous allons avoir des prpriétés, des variables. Un objet pourra en fait avoir différents attributs, différentes propriétés. Pour une classe MaDate, on pourra par exemple imaginer des propriétés pour le nombre de jours, le nombre des mois, le nombre d'années. </p>
            </div>
            <div class="col-12">
